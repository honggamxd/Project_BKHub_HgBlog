      ...
      <div class="navbar">
         <div class="container">
            <div class="row">
              ...
              <div class="brand">
                <a href="index.php">HgBlog - Post Detail</a>
              </div>
		...
		<div class="row">
			...
			<div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8">
            	<div class="header-thumb">
              		 <h1 class="wow fadeIn" data-wow-delay="0.6s">Post Detail</h1>
      ...
      <form class="col-lg-6 offset-lg-3" method="POST" action="" enctype="multipart/form-data"  >
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" id="name"  placeholder="Enter Title" name="title" value="<?php echo $post['title'] ?>">
          </div>
          <div class="form-group">
            <label for="name">Content</label>
            <input type="text" class="form-control" id="email"  placeholder="Enter Content" name="content" value="<?php echo $post['content'] ?>">
          </div>
          <div class="form-group">
            <label for="name">Date</label>
            <input type="datetime" class="form-control" name="datetime" value="<?php echo $post['datetime'] ?>">
          </div>

          <div class="form-group">
            <label for="name">Image</label>
            <input type="file" class="form-control" id="image"  placeholder="Upload image" name="image" value="<?php $post['imgpost'] ?>">
          </div>
